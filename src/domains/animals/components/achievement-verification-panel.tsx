...
/** Shared by /dashboard/admin/achievement-verification and
 * /dashboard/moderator/achievement-verification — reviewing evidence for a breeder-claimed title
 * or diploma on a specific dog (the "is this dog's claimed pedigree/title real" check). Relies on
 * the "moderators manage achievement verification" RLS policy
 * (20260912002000_moderator_verification_access.sql) rather than an RPC — no cascading side
