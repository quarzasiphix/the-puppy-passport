...
import { approveRehomingReview, listRehomingReviews, rejectRehomingReview } from "@/domains/marketplace";

/** Shared by /dashboard/admin/listings and /dashboard/moderator/listings — reviewing a private
 * rehoming submission before it goes public (this is the "is this dog/owner real" check the
 * product owner asked moderators to have; general moderation of already-published breeder/
 * adoption listings is a later phase, see the page's own subtitle below). */
export function RehomingReviewsPanel() {
    ...
    <div>
      <header className="mb-6">
        ...
        <p className="text-sm text-muted-foreground">
          ...
          breeder/adoption listings happens from the Moderation page instead.
        </p>
      </header>
