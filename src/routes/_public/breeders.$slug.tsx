...
import { PuppyCard, LitterCard } from "@/domains/marketplace";
import { ReportDialog } from "@/domains/trust";
import { useAuth } from "@/domains/identity";
import { followOrg, listFollowedOrgIds, unfollowOrg } from "@/domains/marketplace";
import { listKennelPosts, POST_TYPE_LABELS, type PostSummary } from "@/domains/social";
      ...
      <div className="container-page -mt-24 pb-16">
        ...
        <Tabs value={tab} onValueChange={setTab} className="mt-8">
          <TabsList className="w-full flex-wrap justify-start">
            ...
            {kPosts.length > 0 && <TabsTrigger value="posts">Posts</TabsTrigger>}
