  ...
  return (
    <div className="container-page py-10">
      <header className="mb-8 flex flex-wrap items-end justify-between gap-4">
        <div>
          <p className="text-xs font-medium uppercase tracking-wider text-accent">Verified breeders</p>
          <h1 className="mt-1 font-display text-4xl font-medium">Kennels we've vetted personally</h1>
