...
**Original queue**: N (performance), O (privacy/lifecycle), P (launch reconciliation), Q (final
verification + report). (L and M are complete — see table above.)
